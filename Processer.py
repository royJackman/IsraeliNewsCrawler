...
parser.add_option('-s', '--start_year', dest='start_year',
                  type='int', default=2015, help='Year to start parsing')
parser.add_option('-e', '--end_year', dest='end_year', type='int',
                  default=2020, help='Year to end parsing (inclusive)')
parser.add_option('-n', '--sheet_name', action='append', dest='sheet_names',
                  default=[], help='Names of sheets in order of url')
